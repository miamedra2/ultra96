...
#
# edge_detectors.tcl: Tcl script for re-creating project 'edge_detectors'
#
# Generated by Vivado on Fri Jan 15 22:06:44 -0800 2021
...
#
# 1. This project restoration tcl script (edge_detectors.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/github/ultra96/designs/edge_detectors/src/edge_detect_moore.sv"
#    "C:/github/ultra96/designs/edge_detectors/src/edge_detect.sv"
#    "C:/github/ultra96/designs/edge_detectors/src/edge_detect_mealy.sv"
#    "C:/github/ultra96/designs/edge_detectors/src/edge_detect_gate.sv"
#    "C:/github/ultra96/designs/edge_detectors/test/edge_detect_tb.sv"
#    "C:/github/ultra96/designs/edge_detectors/test/edge_detect_mealy.sv"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/github/ultra96/constraints/Ultra96_V2_fsm.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "edge_detectors"
...
set script_file "edge_detectors.tcl"
...
set files [list \
 [file normalize "${origin_dir}/src/edge_detect_moore.sv" ]\
 [file normalize "${origin_dir}/src/edge_detect.sv" ]\
 [file normalize "${origin_dir}/src/edge_detect_mealy.sv" ]\
 [file normalize "${origin_dir}/src/edge_detect_gate.sv" ]\
]
...
set file "src/edge_detect_moore.sv"
...
set file "src/edge_detect_mealy.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "src/edge_detect_gate.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "edge_detect" -objects $obj
...
set file "[file normalize "$origin_dir/../../constraints/Ultra96_V2_fsm.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../constraints/Ultra96_V2_fsm.xdc"
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/test/edge_detect_tb.sv" ]\
 [file normalize "${origin_dir}/test/edge_detect_mealy.sv" ]\
]
...
set file "test/edge_detect_tb.sv"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "test/edge_detect_mealy.sv"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set_property -name "top" -value "edge_detect_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
proc cr_bd_system { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_DDR_RAM_HIGHADDR {0x1FFFFFFF} \
   ...
   CONFIG.PSU__DDRC__BUS_WIDTH {16 Bit} \
...
set obj [get_runs synth_1]
set_property -name "auto_incremental_checkpoint.directory" -value "C:/github/ultra96/designs/edge_detector_moore/edge_detector_moore.srcs/utils_1/imports/synth_1" -objects $obj
...
set obj [get_runs impl_1]
set_property -name "auto_incremental_checkpoint.directory" -value "C:/github/ultra96/designs/edge_detector_moore/edge_detector_moore.srcs/utils_1/imports/impl_1" -objects $obj
