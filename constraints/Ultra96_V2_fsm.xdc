...
# ----------------------------------------------------------------------------
 ...
 ##Clock signal
#set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { sys_clk }]; #IO_L12P_T1_MRCC_35 Sch=sysclk
...
# ---------------------------------------------------------------------------- 
# Bank 65
set_property -dict { PACKAGE_PIN G7   IOSTANDARD LVCMOS33 } [get_ports { reset }];
set_property -dict { PACKAGE_PIN F6   IOSTANDARD LVCMOS33 } [get_ports { level }];
set_property -dict { PACKAGE_PIN G5   IOSTANDARD LVCMOS33 } [get_ports { tick }];
#set_property -dict { PACKAGE_PIN A6   IOSTANDARD LVCMOS33 } [get_ports { led[3] }];
#set_property -dict { PACKAGE_PIN A7   IOSTANDARD LVCMOS33 } [get_ports { resetn }];
...
#set_property -dict { PACKAGE_PIN AA3   IOSTANDARD LVCMOS33 } [get_ports { led[0] }]; #IO_L23P_T3_35 Sch=led[0]
#set_property -dict { PACKAGE_PIN Y5    IOSTANDARD LVCMOS33 } [get_ports { led[1] }]; #IO_L23N_T3_35 Sch=led[1]
#set_property -dict { PACKAGE_PIN AA4   IOSTANDARD LVCMOS33 } [get_ports { led[2] }]; #IO_0_35 Sch=led[2]
#set_property -dict { PACKAGE_PIN AB4   IOSTANDARD LVCMOS33 } [get_ports { led[3] }];
